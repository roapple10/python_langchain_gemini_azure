...
Windows 執行
# Read the file as UTF-16 and save it as UTF-8 (without BOM)
#revise the Path to your exist .env path
$content = Get-Content -Path "C:\Users\User\Downloads\v1\deepwiki-open\.env" -Encoding Unicode
$content | Out-File -FilePath "C:\Users\User\Downloads\v1\deepwiki-open\.env" -Encoding utf8 -NoNewline
