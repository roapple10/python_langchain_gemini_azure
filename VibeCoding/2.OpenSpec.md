...
1. 安裝 OpenSpec：`pip install openspec` 或 `uv tool install openspec`
...
**參考資料：**
- [OpenSpec 官方網站](https://www.aivi.fyi/llms/introduce-OpenSpec)
- [GitHub Repository](https://github.com/github/openspec)
